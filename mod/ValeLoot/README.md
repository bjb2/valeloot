...
- **There is no outbound communication.** Every editor request stays on `127.0.0.1` between the game
  and your browser. The mod does not check for updates, report errors or contact an external service.
